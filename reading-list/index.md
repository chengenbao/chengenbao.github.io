...
<a class="rl-card tech" href="/reading-list/2026-09-23-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM 推理加速与 GPU 体系结构前沿</h2>
    <p>精选 7 篇 arXiv 技术文章，覆盖投机解码、低比特量化、结构化剪枝、KV-Cache 淘汰与 GPU 细粒度调度。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">推理加速 · 量化 · 模型压缩 · KV-Cache · GPU</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-09-22-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-09-22</time></div><h2>约数被11整除的概率 / 3×3方格四色染色计数</h2><p>一道约数条件概率题，一道2×2四色约束方格计数题，均来自 AMC 10 真题。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">数论·组合</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-09-22-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>前沿技术速递：稀疏注意力、MoE 解码加速、NPU 编译器与模型压缩</h2>
    <p>7 篇精选：长上下文稀疏注意力、MoE 多引擎解码、AMD XDNA NPU 编译器、HBF 仿真、LLM 伊辛剪枝、tokenizers v1 与 Granite 4.2 训练栈</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">稀疏注意力 · MoE加速 · NPU编译 · 模型压缩</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-09-20-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>KV缓存加速、低比特量化、GPU指令压缩与内核检测</h2>
    <p>7篇精选：从KV缓存NoC互连、端到端低比特VLM加速，到GPU ISA压缩与Linux容器网络优化。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">KV Cache · 量化 · GPU · 内核 · LLM</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-09-19-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>货币新形态、关税归宿与全球储备格局</h2>
    <p>美联储 FEDS Notes 精选：新形态货币统计、各州关税暴露、黄金与美债储备之争、私募信贷替代、新兴经济体商品周期。</p>
    <div class="rl-meta">
      <span class="rl-source">Fed FEDS Notes</span>
      <span class="rl-tags">#宏观 #贸易 #储备 #信贷 #新兴</span>
    </div>
  </div>
</a>
...
<a class="rl-card math" href="/reading-list/2026-09-18-math/">
  ...
  <div class="rl-body">
    ...
    <h2>坐标平面三角形面积 / 整数方程组的对称求和</h2>
    <p>几何（鞋带公式+对数坐标）与数论（整数方程组因式分解）两道 AMC 12 真题详解。</p>
    <div class="rl-meta">
      <span class="rl-source">AMC 10/12 竞赛真题</span>
      <span class="rl-tags">#几何 #数论</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-09-18-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>KV缓存稀疏化、长上下文推理路由与扩散采样加速</h2>
    <p>今日聚焦大模型推理效率：KV缓存稀疏化、长上下文路由、扩散采样加速，以及分布式RL、量化和高性能算子方向。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · KV缓存 · 扩散加速 · 分布式RL · 量化</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-09-17-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-09-17</time></div><h2>五连整数子集概率 / 三次方程根对称和</h2><p>两道 2025 AMC 12A 真题：五连整数子集的概率（组合计数），与三次方程根的对称和（韦达定理）。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">概率 · 代数 · AMC12</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-09-15-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>GPU利用率 / PyTorch剖析 / LLM压缩推理 / 异步GRPO / OS调度 / MoE卸载 / 端侧量化</h2>
    <p>今日 7 篇聚焦大模型推理加速、硬件剖析与分布式训练的工程向深度技术文章。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">Tech · GPU · PyTorch · LLM · 分布式训练</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-09-14-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-09-14</time></div><h2>多项式根的对称式 / 有序三元组的计数</h2><p>2025 AMC 12A 两道真题：多项式根的对称式 + 有序三元组计数。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">代数 · 组合</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-09-14-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <div class="rl-meta">
      <span class="rl-source">HuggingFace</span>
...
<a class="rl-card tech" href="/reading-list/2026-09-08-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM 推理加速与量化前沿：MoE 解码、KV Cache、存储 Roofline 与混合精度</h2>
    <p>今日精选 7 篇深度技术文章，聚焦大模型推理加速、量化压缩与分布式 serving 系统。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · 量化 · MoE · KV Cache · 混合精度</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-09-07-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-09-07</time></div><h2>分组计数中的「去标签」 / 三局两胜季后赛夺冠概率</h2><p>2024 AMC 10A 两道经典真题：无标号组队计数 + 三局两胜夺冠概率建模求解。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">组合 · 概率</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-09-03-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>大模型量化、MoE推理加速与GPU可靠性前沿</h2>
    <p>7篇精选：端侧内存管理、近数据MoE调度、GPU静默损坏、端到端量化、CUDA智能体生成、去中心化LoRA、长上下文解码。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">量化 · MoE · GPU · 分布式 · 推理加速</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-09-01-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>推理加速 · 量化安全 · 硬件架构 · 扩散解码</h2>
    <p>6 篇核心 infra 论文：循环状态量化、向量索引输出层、硬件内存墙、扩散投机解码、量化后门、性能预测</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv</span>
      <span class="rl-tags">LLM · 推理加速 · 量化 · 硬件架构</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-08-28-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>天气定价、双重股权与财富不平等的多维透视</h2>
    <p>5 篇精选：从锡兰红茶的天气定价到全球财富不平等的社会网络根源，覆盖宏观、微观与国际视角。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv econ.GN</span>
      <span class="rl-tags">#宏观 #微观 #国际 #公司治理</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-08-27-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-08-27</time></div><h2>子集的最密填充 / 递推数列与求和放缩</h2><p>AMC 10/12 真题：组合题（子集最密填充）与代数题（递推数列求和放缩）。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">#奥数题 #AMC10 #AMC12 #组合 #代数</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-08-27-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>大模型量化、KV Cache 压缩与 CPU/硬件推理协同设计</h2>
    <p>今日精选 7 篇，覆盖量化微调、KV Cache 压缩、INT8 加速器与 CPU 推理带宽优化。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">量化 · KV Cache · 推理加速 · 硬件加速器</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-08-23-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>编译栈启用、GPU 调度与 MoE 微调加速</h2>
    <p>编译栈首日启用、GPU 调度提效、知识蒸馏与 MoE 微调加速等 7 篇前沿技术速递。</p>
    <div class="rl-meta">
      <span class="rl-source">PyTorch / HuggingFace</span>
      <span class="rl-tags">模型启用 · GPU调度 · 知识蒸馏 · 内核 · 推理服务 · MoE微调</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-08-16-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>预训练语料 · 推理加速 · 机制可解释性 · 开放模型 · 可信智能体</h2>
    <p>今日精选 6 篇 arXiv 技术文章，涵盖可控预训练语料、无损投机解码、SAE 特征解释、开放许可模型、可验证代码生成与科学智能体。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv</span>
      <span class="rl-tags">Tech · arXiv · 前沿</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-08-15-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>美联储视角：AI 贸易、银行韧性与信贷风险</h2>
    <p>5 篇 FEDS Notes 覆盖宏观、国际、市场微观、银行稳健与信贷维度。</p>
    <div class="rl-meta">
      <span class="rl-source">Fed FEDS Notes</span>
      <span class="rl-tags">#宏观 #银行 #贸易 #信贷</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-08-12-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>利率、城市劳动力、冲突矿产与AI能源</h2>
    <p>机器学习预测收益率曲线、远程办公下的城市职场依赖、冲突矿产监管、AI数据中心能耗。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv econ.GN</span>
...
<a class="rl-card tech" href="/reading-list/2026-08-12-tech-daily/">
  <div class="rl-accent"></div>
  <div class="rl-body">
    <div class="rl-top">
      <span class="rl-badge tech">📰 技术速递</span>
    ...
    <h2>MoE压缩·KV Cache·可解释训练·端侧推理</h2>
    <p>7篇精选：MoE专家压缩与剪枝、KV Cache压缩、可解释语言模型、推理算力分配、OS内存翻译、端侧智能体。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">Tech · MoE · 推理加速 · 可解释性 · 端侧</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-08-11-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-08-11</time></div><h2>余数定义推广 / 单调正整数计数</h2><p>两道 AMC 10 真题：实数余数的 floor 定义应用，与单调数的组合计数。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">数论 · 组合</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-08-11-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>量化损伤·稀疏注意力·分布式GNN·HLS编译</h2>
    <p>7篇前沿：低位宽量化误差理论、SmartNIC全图GNN训练、无训练稀疏注意力、扩散LM线性注意力、结构化剪枝、GPU功耗建模与HLS自动翻译。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">Tech · arXiv · PyTorch · HuggingFace</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-08-06-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM 低位量化与推理加速：KV-Cache、MX 格式、存内计算与扩散解码</h2>
    <p>今日 6 篇聚焦 LLM 低位量化与推理加速：KV-Cache/INT2、微缩放 MX、存内计算、Mamba FPGA 加速与扩散解码。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">量化 · 推理加速 · 硬件协同 · SSM · 扩散模型</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-08-05-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-08-05</time></div><h2>数字位值整除 / 3×3 网格染色计数</h2><p>两道 AMC 10 真题：数论（位值整除）与组合（拉丁方计数）。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">数论 · 组合</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-08-05-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>编译器、GPU内核与OS验证前沿</h2>
    <p>7篇精选覆盖 MLIR 编译、GPU L1 共享、双稀疏 LLM 推理、文件系统模型检验与推理时 RL 对齐。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">编译器 · GPU · LLM推理 · OS验证 · 强化学习</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-08-01-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>宏观惯性、消费立场与 AI 决策</h2>
    <p>4 篇精选：宏观模型惯性机理、企业价值观对消费的影响、AI 谄媚对决策的扭曲、危机下的内群体偏好。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv econ</span>
      <span class="rl-tags">#宏观 #行为经济 #AI决策</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-07-27-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>投机解码与KV缓存新解、Apple M5推理引擎、GPU NUMA剖析与分布式训练优化</h2>
    <p>7 篇论文覆盖长上下文投机解码、KV缓存驱逐理论、Apple M5 LLM推理、GPU NUMA架构、数据并行通信优化、AI芯片科学计算与RISC-V端侧训练。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">投机解码 · KV缓存 · GPU · 分布式训练 · AI芯片</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-07-26-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-07-26</time></div><h2>直角四边形面积 / 全偶数位四位数计数</h2><p>直角四边形对角线求面积（射影定理）+ 全偶数位且被5整除的四位数计数</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">几何 · 数论</span></div></div></a>
<a class="rl-card finance" href="/reading-list/2026-07-26-finance-daily/">
  <div class="rl-accent"></div>
  <div class="rl-body">
    <div class="rl-top">
      <span class="rl-badge finance">💰 财经精选</span>
    ...
    <h2>宏观周期、加密监管与系统性风险</h2>
    <p>美国房地产信贷周期、欧盟稳定币监管、供应链系统性风险与欧洲能源独立。</p>
    <div class="rl-meta">
      <span class="rl-source">Fed / BIS / WSJ / FT</span>
      <span class="rl-tags">#宏观 #财经</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-07-24-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>关税、供应链与地缘风险下的多维观察</h2>
    <p>5 篇 Fed 研究：FDI 回流、供应短缺量化、地缘风险敞口、远程办公生产率与关税通胀传导</p>
    <div class="rl-meta">
      <span class="rl-source">Fed FEDS Notes</span>
      <span class="rl-tags">#宏观 #地缘 #供应链</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-07-22-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>每日技术速递：LLM核函数评测、推测解码、模型量化与MoE硬件加速</h2>
    <p>覆盖 CUDA 核函数评测、线性注意力推测解码、递归模型量化、GPU 共置调度、MoE 加速器、Agentic RL rollout 与 NPU DVFS 能效等系统级前沿。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · 量化 · 硬件加速</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-07-21-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-07-21</time></div><h2>整数长方体三元组计数 / 掷骰子累计和的概率</h2><p>组合计数 + 概率计算，两道 AMC 10 真题精解</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">组合, 概率</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-07-20-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>端侧推理、世界模型与分布式微调的前沿实践</h2>
    <p>今日 6 篇精选覆盖 NeMo 大规模微调、LeRobot 世界模型、SkyPilot 零出口存储、Agent 架构、领域专精 OCR 与 ExecuTorch 端侧优化。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">大模型微调 · 机器人 · 云存储 · Agent</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-07-19-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-07-19</time></div><h2>12枚令牌的分配概率 / 三次方程根的乘积式求值</h2><p>12枚令牌随机分配的概率 + 三次方程根的乘积式求值，两道 AMC 12 真题带你练手。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">概率 · 代数 · AMC12</span></div></div></a>
<a class="rl-card finance" href="/reading-list/2026-07-19-finance-daily/">
  <div class="rl-accent"></div>
  <div class="rl-body">
    <div class="rl-top">
      <span class="rl-badge finance">💰 财经精选</span>
    ...
    <h2>AI基建、贸易重构与稳定币：美联储FEDS Notes四篇精选</h2>
    <p>本期聚焦美联储近期研究，覆盖AI对经济与就业的影响、越南对美出口背后的中国企业角色、稳定币时代的银行创新应对。</p>
    <div class="rl-meta">
      <span class="rl-source">Fed FEDS Notes</span>
      <span class="rl-tags">#AI #贸易 #稳定币 #银行</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-07-17-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM推理优化·芯片架构·编译器与训练</h2>
    <p>今日 7 篇精选覆盖 LLM 推理加速、结构化剪枝恢复、Muon 优化器、Triton 插件、解码芯片经济学、存算一体与 OS 调优。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">Tech · LLM · GPU · 编译器 · 推理加速</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-07-16-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-07-16</time></div><h2>无穷根式乘积 / 1-14 配对组合</h2><p>2022 AMC 12A 真实真题：指数无穷乘积 + 构造性配对计数。</p><div class="rl-meta"><span class="rl-source">AMC 10/12 竞赛真题</span><span class="rl-tags">#代数 #组合 #AMC12</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-07-16-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>大模型推理加速与边缘异构计算前沿</h2>
    <p>精选 7 篇 arXiv 前沿：稀疏注意力 TopK、NPU 推理运行时、知识蒸馏重排序、N:M 稀疏 Transformer、异构边缘推理与 LoRA 显存优化。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · 稀疏计算 · 异构边缘 · 模型压缩</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-07-11-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>长上下文·存内计算·FPGA加速·LLM Agent工具生成</h2>
    <p>覆盖 RoPE 长上下文扩展、PIM 推理、光纤存储架构、FPGA 加速、LLM Agent 共 7 篇前沿技术文章</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM · 体系结构 · 推理加速 · FPGA · Agent</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-07-10-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-07-10</time></div><h2>数列中的整除性 / Farey 分数序列</h2><p>探索数列整除规律与分数排列之美——来自 NRICH 剑桥数学题库</p><div class="rl-meta"><span class="rl-source">NRICH 剑桥数学题库</span><span class="rl-tags">初二 初三</span></div></div></a>
...
<a class="rl-card finance" href="/reading-list/2026-07-09-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>量化金融·宏观预测·泡沫检测·新兴市场</h2>
    <p>市场微观结构与交易平滑性、AI vs 点com泡沫识别、RL价格操纵检测、实时宏观预测修订风险及IMF新兴市场案例</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv econ / arXiv q-fin</span>
      <span class="rl-tags">#量化金融 #宏观预测 #IMF</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-07-07-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>AI经济·劳动市场·房地产风险·宏观建模</h2>
    <p>AI对不平等的影响、自动化与公共财政、日本工资停滞、佛州房地产风险定价、DSGE宏观模型</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv q-fin/econ</span>
      <span class="rl-tags">#AI经济 #劳动市场 #宏观政策</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-07-05-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM推理架构、量化加速与蒸馏优化前沿（2026-07-05）</h2>
    <p>覆盖3D芯片LLM推理、混合精度GEMM加速、扩散模型无数据量化、LLM自蒸馏训练优化共6篇。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · 量化 · 自蒸馏 · 硬件加速</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-07-04-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-07-04</time></div><h2>倾斜正方形的面积 / 彩色涂漆大立方体</h2><p>初二：勾股定理推导倾斜正方形面积；初三：涂漆立方体的空间几何与二项式展开</p><div class="rl-meta"><span class="rl-source">NRICH 竞赛真题</span><span class="rl-tags">NRICH · 初二 · 初三</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-07-04-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>KV Cache 压缩 · 量化推理 · 硬件加速 · 深度学习理论</h2>
    <p>LLM 推理加速全栈覆盖：KV Cache 压缩理论与实践、NPU/ASIC 量化内核、3D 堆叠架构，附深度学习理论新作。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">KV Cache · 量化 · 推理加速 · 硬件架构</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-06-25-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>大模型经济学与量化金融前沿</h2>
    <p>聚焦AI Token定价、IPO分析智能体、再生债券创新与跨分布组合管理四大前沿议题</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv Econ / arXiv Quant Finance</span>
      <span class="rl-tags">#AI经济 #量化金融</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-06-18-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>MoE量化、推理加速与边缘部署：大模型效率前沿六篇</h2>
    <p>覆盖MoE混合精度量化、AI加速器评测、边缘实时推理、Transformer算子加速、解耦推理调度与LLM蒸馏六大方向</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">量化 · 推理加速 · 分布式 · 边缘部署 · 蒸馏</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-06-16-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM推理优化 · 模型加速 · 系统级AI研究（2026-06-16）</h2>
    <p>精选 6 篇最新技术论文，覆盖 cs.AR / cs.LG / cs.CL</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM GPU INFERENCE</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-06-15-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>货币政策传导机制与金融市场微观结构</h2>
    <p>美联储工作论文精选：清算速度与金融稳定、利率传导机制实证、泰勒规则渐进主义、共同基金经理效率</p>
    <div class="rl-meta">
      <span class="rl-source">Fed Working Papers</span>
      <span class="rl-tags">#货币政策 #金融稳定 #共同基金</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-06-06-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>KV Cache优化 · CUDA调度 · 投机解码 · MoA调度 · LLM Agent · 稀疏注意力</h2>
    <p>聚焦 LLM 推理加速、CUDA 系统优化与智能体框架前沿进展，精选 6 篇 arXiv 新论文。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · CUDA优化 · 稀疏注意力</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-06-02-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM 推理优化 · FP4量化 · GEMM性能 · 自主数据工程</h2>
    <p>今日聚焦推理内存墙、FP4混合精度量化、GEMM性能粗糙性、以及自主Agent数据工程等前沿方向</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · 量化 · GPU · 分布式</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-05-31-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>PyTorch Profiler + RL Delta Sync + LLM企业IT基准 · 6篇</h2>
    <p>今日精选：PyTorch profiling实战、RL万亿参数增量同步、LLM企业IT基准、Agent术语梳理、专业化vs规模化</p>
    <div class="rl-meta">
      <span class="rl-source">HuggingFace / PyTorch</span>
      <span class="rl-tags">PyTorch · RL · LLM · Agent · 性能优化</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-05-30-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-05-30</time></div><h2>运算顺序 / 年龄推算</h2><p>2023 & 2022 AMC 8 竞赛真题，四年级运算顺序、五年级年龄推算</p><div class="rl-meta"><span class="rl-source">AMC 竞赛真题</span><span class="rl-tags">四年级 · 五年级</span></div></div></a>
...
<a class="rl-card tech" href="/reading-list/2026-05-30-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM推理引擎 · MoE显存优化 · RL vs SFT遗忘机理 · LoRA特征几何 · 上下文蒸馏 · 硬件感知NAS</h2>
    <p>覆盖大模型推理系统、MoE部署、微调机理与硬件感知架构搜索6篇前沿研究</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / cs.LG / cs.AR</span>
      <span class="rl-tags">大模型推理 · MoE · LoRA · 硬件优化</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-05-20-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>战争贸易・AI洗绿・自动化・数字就业・通胀</h2>
    <p>5篇前沿研究覆盖国际贸易地缘政治、公司金融ESG、全球自动化、数字经济就业与宏观通胀</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv econ.GN</span>
      <span class="rl-tags">#国际贸易 #AI洗绿 #自动化 #数字经济 #通货膨胀</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-05-17-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>大模型基础设施 · 智能体推理 · RLVR · 嵌入模型 · 世界模型 · mlx</h2>
    <p>涵盖分布式训练架构、VAKRA 智能体基准、Ecom-RLVE 强化学习、Granite 嵌入模型、Waypoint 世界模型与 mlx 框架迁移。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM · Agent · RLVR · Embedding · WorldModel</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-05-15-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>MOPD蒸馏 · 双室模型 · 异步推理批处理 · 近内存Ising · CHERI时序安全</h2>
    <p>MOPD蒸馏·双室隐状态耦合·异步推理批处理·近内存Ising加速·CHERI时序安全</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / HuggingFace</span>
      <span class="rl-tags">LLM · 推理 · 硬件</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-05-14-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>MoE推理加速 · 扩散LLM并行 · 量化优化 · PyTorch 2.12</h2>
    <p>今日精选7篇前沿技术文章，覆盖MoE训练/推理加速、扩散语言模型并行、块浮点量化、芯片互联及LLM多轮服务优化。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">MoE · 量化 · 分布式训练 · 推理加速</span>
    </div>
  </div>
</a>
<a class="rl-card math" href="/reading-list/2026-05-13-math/"><div class="rl-accent"></div><div class="rl-body"><div class="rl-top"><span class="rl-badge math">🧮 奥数题</span><time>2026-05-13</time></div><h2>钱包谜题：笔与铅笔 / 珠子颜色的规律</h2><p>从方程思维到组合规律，六年级代数入门 + 初一逻辑推理</p><div class="rl-meta"><span class="rl-source">NRICH 竞赛真题</span><span class="rl-tags">六年级 · 初一 · 方程 · 组合</span></div></div></a>
<a class="rl-card finance" href="/reading-list/2026-05-13-finance-daily/">
  <div class="rl-accent"></div>
  <div class="rl-body">
    <div class="rl-top">
      <span class="rl-badge finance">💰 财经精选</span>
    ...
    <h2>货币历史·AI创业·经济预测·发展范式</h2>
    <p>精选5篇arXiv经济学论文：西班牙价格革命、生成式AI与创业、夜光数据预测收入、中等收入陷阱新范式、宏观预测ML实战。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv econ.GN / econ.EM</span>
      <span class="rl-tags">#货币历史 #AI创业 #宏观预测</span>
    </div>
  </div>
</a>
...
<a class="rl-card tech" href="/reading-list/2026-05-06-tech-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>LLM 推理加速 · GPU 内核优化 · 分布式训练 · 边缘部署</h2>
    <p>从 GPU warp 级 CUDA 内核到 NPU-PIM 混合架构，聚焦 2026 年大模型推理与系统优化前沿。</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM推理 · GPU · Speculative Decoding · NCCL · Edge AI</span>
    </div>
  </div>
</a>
...
<a class="rl-card finance" href="/reading-list/2026-04-30-finance-daily/">
  ...
  <div class="rl-body">
    ...
    <h2>泡沫识别、利率理论与风险模型</h2>
    <p>覆盖投机泡沫检测、财产溢价利率论、出生不平等与LFRRA效用函数四篇前沿研究</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv q-fin / econ.GN</span>
      <span class="rl-tags">#量化金融 #宏观经济 #风险管理</span>
    </div>
  </div>
</a>
<a class="rl-card tech" href="/reading-list/2026-04-30-tech-daily/">
  <div class="rl-accent"></div>
  <div class="rl-body">
    <div class="rl-top">
      <span class="rl-badge tech">📰 技术速递</span>
    ...
    <h2>LLM推理加速与分布式训练新进展</h2>
    <p>涵盖存内计算加速、1.58-bit量化硬件、移动端推测解码、序列并行训练及RL后训练机制研究</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv / PyTorch / HuggingFace</span>
      <span class="rl-tags">LLM · 推理加速 · 分布式训练 · 量化 · 硬件</span>
    </div>
  </div>
</a>
...
<a class="rl-card math" href="/reading-list/2026-04-26-math/">
  ...
  <div class="rl-body">
    ...
    <h2>连乘积化简（初二） / 三角形中的正方形（初三）</h2>
    <p>望远镜连乘积化简技巧；直角三角形内三个正方形的相似传递关系</p>
    <div class="rl-meta">
      <span class="rl-source">2024 CEMC Cayley Contest 真题</span>
      <span class="rl-tags">#连乘积 #相似三角形 #几何</span>
    </div>
  </div>
</a>

<a class="rl-card finance" href="/reading-list/2026-04-26-finance-daily/">
  <div class="rl-accent"></div>
  <div class="rl-body">
    <div class="rl-top">
      <span class="rl-badge finance">💰 财经精选</span>
    ...
    <h2>操作风险·生物多样性金融·澳洲房价·LLM 价格发现</h2>
    <p>宏观风险 HMM 建模、绿色金融知识图谱、利率与房价脱钩机制、冻结 LLM 的股价预测力</p>
    <div class="rl-meta">
      <span class="rl-source">arXiv q-fin / econ</span>
      <span class="rl-tags">#宏观风险 #操作风险 #压力测试 #隐马尔可夫</span>
    </div>
  </div>
</a>
...
<a class="rl-card math" href="/reading-list/2026-04-20-math/">
  ...
  <div class="rl-body">
    ...
    <h2>数字分组均等（初二） / 网格概率（初三）</h2>
    <p>枚举分类讨论求和约束分组，乘法原理计算网格菱形概率</p>
    <div class="rl-meta">
      <span class="rl-source">AMC 8 2023 真题</span>
      <span class="rl-tags">#组合数学 #古典概率</span>
    </div>
  </div>
</a>
...
<a class="rl-card math" href="/reading-list/2026-03-13-math/">
  ...
  <div class="rl-body">
    ...
    <h2>字母循环填表规律（四年级）/ 青蛙比例问题（五年级）</h2>
    <p>模运算计数找规律 + 比例方程联立求解</p>
    <div class="rl-meta">
      <span class="rl-source">AMC 8 真题（2023 / 2024）</span>
      <span class="rl-tags">#余数 #规律 #比例 #方程</span>
    </div>
  </div>
</a>
